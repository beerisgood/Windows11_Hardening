...
- [x] Use the only browser which provide [defense in depth](https://learn.microsoft.com/deployedge/microsoft-edge-security-browse-safer#defense-in-depth): [Edge](https://www.microsoft.com/en-us/edge)
